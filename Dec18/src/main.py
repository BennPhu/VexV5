...
# 	Module:       main.py                                                      #
# 	Author:       bentdm197                                                    #
# 	Created:      12/18/2024, 12:59:34 PM                                       #
...
elevator_motor.set_velocity(80, PERCENT)
...
def autonomous():
    ...
    robot.drive_for(FORWARD, 260, MM)
    ...
    wait(100, MSEC)
    group_right.spin_for(FORWARD, 335, DEGREES)
    ...
    #1 METHOD
    group_right.spin_for(REVERSE, 560, DEGREES)
