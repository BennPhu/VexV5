...
elevator_motor.set_velocity(85, PERCENT)
...
def autonomous():
    ...
    robot.drive_for(FORWARD, 265, MM)
    # robot.drive_for(FORWARD, 250, MM)


    robot.turn_for(RIGHT, 18.5, DEGREES)
    ...
    wait(100, MSEC)
    robot.drive_for(FORWARD, 550, MM, 60, PERCENT)
    wait(100, MSEC)
    group_right.spin_for(FORWARD, 325, DEGREES)
    ...
    robot.drive_for(FORWARD, 1225, MM, 50, PERCENT)
    ...
    #1 METHOD
    group_right.spin_for(REVERSE, 550, DEGREES)
    ...
    wait(1300, MSEC)
    robot.drive_for(FORWARD, 330, MM, 50, PERCENT)  
##########################RIGHT SIDEEE
    wait(100, MSEC)
    robot.turn_for(LEFT, 19, DEGREES)
    group_left.set_velocity(30, PERCENT)
    ...
    wait(100, MSEC)
    robot.drive_for(FORWARD, 560, MM, 60, PERCENT)
    wait(100, MSEC)
    group_left.spin_for(FORWARD, 270, DEGREES)
    ...
    wait(200, MSEC)
    #take the other 3 rings
    robot.turn_for(RIGHT, 15.5, DEGREES, 60, PERCENT)
    robot.drive_for(FORWARD, 1220, MM, 50, PERCENT)
    ...
    #######2 SCENARIOS (group right or turn right)
    #1 METHOD
    group_left.spin_for(REVERSE, 550, DEGREES)
    ...
    robot.drive_for(REVERSE, 150, MM, 50, PERCENT)
    wait(600, MSEC)
    robot.turn_for(LEFT, 24, DEGREES)
    mobile_goal_motor.set_stopping(COAST)
    mobile_goal_motor.spin_for(FORWARD, 1000, MSEC) 
    wait(300, MSEC)
    robot.drive_for(FORWARD, 100, MM, 60, PERCENT)
    ...
    robot.drive_for(FORWARD, 200, MM, 70, PERCENT)
    wait(100, MSEC)
    robot.turn_for(RIGHT, 9, DEGREES)
    robot.drive_for(FORWARD, 1700, MM)

    # robot.drive_for(FORWARD, 300, MM)
    # robot.turn_for(RIGHT, 19, DEGREES)
    # robot.drive_for(FORWARD, 1000, MM)
    # robot.turn_for(LEFT, 15, DEGREES)
    # robot.drive_for(FORWARD, 700, MM)
